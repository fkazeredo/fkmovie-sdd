...
public class UserManagementService {
     ...
     */
    @Transactional
    public User invite(String email, String name, Role role, UUID actingAdminId) {
    ...
    public Page<User> list(Role role, UserStatus status, Pageable pageable) {
        return users.search(role, status, pageable);
    }
    ...
    @Transactional
    public User changeRole(UUID id, Role newRole, UUID actingAdminId) {
    ...
    @Transactional
    public User disable(UUID id, UUID actingAdminId) {
        var user = users.findById(id).orElseThrow(UserNotFoundException::new);
    ...
    @Transactional
    public User enable(UUID id, UUID actingAdminId) {
        var user = users.findById(id).orElseThrow(UserNotFoundException::new);
        user.enable();
