...
public interface ReservationRepository extends JpaRepository<Reservation, UUID> {
    ...
    @Query("select r from Reservation r where r.status = com.fksoft.domain.booking.ReservationStatus.PENDING "
    ...
    @Query("select r from Reservation r where r.status = "
            + "com.fksoft.domain.booking.ReservationStatus.AWAITING_PAYMENT "
